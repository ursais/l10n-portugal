...
from odoo.addons.l10n_pt_future.tests.common import TestL10nPtCommon
...
class TestL10nPtHashing(TestL10nPtCommon):
    def test_l10n_pt_hash_sequence(self):
        ...
        with patch('odoo.addons.l10n_pt_future.models.account_move.AccountMove._get_l10n_pt_document_number', _get_l10n_pt_document_number_patched):
